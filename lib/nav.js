// Navigation model: grouped tabs for students and admins.
...
export const studentNav = [
  { id: "dashboard", label: "Home", icon: "home", href: "/student" },
  {
    ...
    children: [
      ...
      { id: "resources", label: "Resources", icon: "library", href: "/student/resources", desc: "Curated tracks and courses" },
      { id: "insights", label: "Insights", icon: "trending", href: "/student/insights", desc: "Growth, peers, next step" }
    ]
  },
  {
    ...
    children: [
      ...
      { id: "github", label: "GitHub", icon: "branch", href: "/student/github", desc: "Activity and connections" },
      { id: "opensource", label: "Open Source", icon: "pull", href: "/student/opensource", desc: "Claim PRs, earn badges" }
    ]
  },
  {
    id: "compete", label: "Compete", icon: "trophy", href: "/student/contests",
    children: [
      { id: "contests", label: "Contests", icon: "trophy", href: "/student/contests", desc: "Weekly practice and CTFs" },
      { id: "events", label: "Events", icon: "calendar", href: "/student/events", desc: "Workshops and hackathons" },
      { id: "leaderboard", label: "Board", icon: "chart", href: "/student/leaderboard", desc: "Chapter standings" }
    ]
  },
  {
    id: "people", label: "People", icon: "handshake", href: "/student/mentorship",
    children: [
      { id: "mentorship", label: "Mentors", icon: "handshake", href: "/student/mentorship", desc: "Guidance from seniors" },
      { id: "community", label: "Community", icon: "chat", href: "/student/community", desc: "Forums, wiki, snippets" },
      { id: "network", label: "Network", icon: "network", href: "/student/network", desc: "Chapters across campuses" },
      { id: "discover", label: "Discover", icon: "compass", href: "/student/discover", desc: "Trending and rising builders" }
    ]
  },
  { id: "credentials", label: "Proof", icon: "award", href: "/student/credentials" }
];

export const studentSecondary = [
  { id: "notifications", label: "Alerts", icon: "bell", href: "/student/notifications" },
  { id: "privacy", label: "Privacy", icon: "shield", href: "/student/privacy" },
...
export const mobileNav = [
  ...
  { group: "compete", label: "Play", icon: "trophy", href: "/student/contests" },
  { group: "people", label: "People", icon: "chat", href: "/student/community" }
];
...
export function pathToTab(pathname, area) {
  ...
  return matchLeaf([...studentNav, ...studentSecondary], pathname)?.id ?? "dashboard";
}
